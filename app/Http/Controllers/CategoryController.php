...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('categories.index', compact('categories','materials'));
    }
    ...
    public function exportCategory($id)
    {
        ...
        $pdf = PDF::loadView('categories.categoriesPDF', compact('category','material','data'))->setPaper('a4','landscape');
