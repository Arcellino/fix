                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            {!! Form::select('material_id', $materials, null, ['class' => 'form-control select', 'placeholder' => '-- Choose Product --', 'id' => 'material_id', 'required']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="total_mat_datang" name="total_mat_datang" required>
                            <span class="help-block with-errors"></span>
                        </div>
