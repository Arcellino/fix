...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
            <div class="inner">
                <h3>{{ \App\Material::count() }}</h3>
                <p>Material</p>
            </div>
            <div class="icon">
                <i class="ion ion-person-add"></i>
            </div>
            <a href="{{ route('materials.index') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-maroon">
            <div class="inner">
                <h3>{{ \App\material_masuk::count() }}</h3>
            ...
            <a href="{{ route('materialsIn.index') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-gray">
            <div class="inner">
                <h3>{{ \App\material_keluar::count()  }}</h3>
            ...
            <a href="{{ route('materialsOut.index') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
</div>
