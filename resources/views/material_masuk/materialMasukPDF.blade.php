...
<div class="invoice-box">
    ...
    <table border="0" id="table-data" width="100%" align="center">
        <tr>
            ...
            <td width="">: {{ $material_masuk->id }}</td>
            <td width="30px">Created</td>
            <td>: {{ $material_masuk->tanggal }}</td>
        </tr>

        <tr>
            <td>Telepon</td>
            <td>: {{ $material_masuk->supplier->telepon }}</td>
            <td>Alamat</td>
            <td>: {{ $material_masuk->supplier->alamat }}</td>
        </tr>

        <tr>
            <td>Nama</td>
            <td>: {{ $material_masuk->supplier->nama }}</td>
            <td>Email</td>
            <td>: {{ $material_masuk->supplier->email }}</td>
        </tr>

        <tr>
            <td>Material</td>
            <td >: {{ $material_masuk->material->nama_material }}</td>
            <td>Quantity</td>
            <td >: {{ $material_masuk->total_mat_datang }}</td>
        </tr>
